...
func (x *RequestFindByIds) Reset() {
	*x = RequestFindByIds{}
	if protoimpl.UnsafeEnabled {
		mi := &file_amenity_amenity_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RequestFindByIds) Descriptor() ([]byte, []int) {
	return file_amenity_amenity_proto_rawDescGZIP(), []int{5}
}
...
func (x *ResponseFindByIds) Reset() {
	*x = ResponseFindByIds{}
	if protoimpl.UnsafeEnabled {
		mi := &file_amenity_amenity_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ResponseFindByIds) Descriptor() ([]byte, []int) {
	return file_amenity_amenity_proto_rawDescGZIP(), []int{6}
}
...
var file_amenity_amenity_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_amenity_amenity_proto_goTypes = []interface{}{
	...
	(*RequestFindByIds)(nil),  // 5: amenity.RequestFindByIds
	(*ResponseFindByIds)(nil), // 6: amenity.ResponseFindByIds
}
var file_amenity_amenity_proto_depIdxs = []int32{
	2, // 0: amenity.ResponseFindByIds.amenities:type_name -> amenity.ResponseDetails
	0, // 1: amenity.AmenityService.Create:input_type -> amenity.RequestCreate
	1, // 2: amenity.AmenityService.Details:input_type -> amenity.RequestDetails
	3, // 3: amenity.AmenityService.CheckExist:input_type -> amenity.RequestExist
	5, // 4: amenity.AmenityService.FindByIds:input_type -> amenity.RequestFindByIds
	2, // 5: amenity.AmenityService.Create:output_type -> amenity.ResponseDetails
	2, // 6: amenity.AmenityService.Details:output_type -> amenity.ResponseDetails
	4, // 7: amenity.AmenityService.CheckExist:output_type -> amenity.ResponseExist
	6, // 8: amenity.AmenityService.FindByIds:output_type -> amenity.ResponseFindByIds
...
func file_amenity_amenity_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_amenity_amenity_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_amenity_amenity_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
...
func (c *amenityServiceClient) FindByIds(ctx context.Context, in *RequestFindByIds, opts ...grpc.CallOption) (*ResponseFindByIds, error) {
	out := new(ResponseFindByIds)
	err := c.cc.Invoke(ctx, "/amenity.AmenityService/FindByIds", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedAmenityServiceServer) FindByIds(context.Context, *RequestFindByIds) (*ResponseFindByIds, error) {
...
func _AmenityService_FindByIds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestFindByIds)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AmenityServiceServer).FindByIds(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/amenity.AmenityService/FindByIds",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AmenityServiceServer).FindByIds(ctx, req.(*RequestFindByIds))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _AmenityService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AmenityService_FindByIds_Handler,
		},
	},
